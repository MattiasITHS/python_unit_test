...
class TestCalculate(unittest.TestCase):
    ...
    def test_calculate_medium_first(self):
        with self.assertRaises(TypeError):
            Calculator("111111","111111","111111","111111","1111111")

    def test_calculate_medium_second(self):
        with self.assertRaises(TypeError):
            Calculator(15000,80000,218.15,20000,60000)

    def test_calculate_medium_third(self):
        with self.assertRaises(TypeError):
            Calculator(15000, 80000, 218.15, 20000, True)
    ...
    def test_calculate_hard_second(self):
        with self.assertRaises(TypeError):
            Calculator(1111111, None, None, None, None)

    def test_calculate_hard_third(self):
        with self.assertRaises(TypeError):
            Calculator(22222, 1232123, 4123512, 124123, Exception)
